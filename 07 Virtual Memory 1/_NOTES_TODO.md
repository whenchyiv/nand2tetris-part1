...
- [x] complete main loop file parsing and handling.
- [ ] write automated tests for the parser.py
- [x] Add an iterator that lets us iterate over the lines as a python for loop? Rather than having to do a while or similar?
